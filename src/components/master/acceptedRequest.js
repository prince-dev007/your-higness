...
import AcceptMark from '../../assets/images/acceptmarka.png';
import { validaterrorMasterSearchFields } from '../../helpers/index';
import { checkMasterScam, fetchApprovedService, viewSingleService } from '../../actions';

/**
 * This is AcceptedRequest class which hold Accepted Request component.
 */
class AcceptedRequest extends Component {
  ...
  componentDidMount() {
    const { fetchApprovedCurrentServices, checkCurrentMasterScam } = this.props;
    const masterSession = localStorage.getItem('masterSessionID');
    checkCurrentMasterScam(masterSession);
    fetchApprovedCurrentServices(masterSession, 1);
  }

  nextPage(data) {
    const masterSession = localStorage.getItem('masterSessionID');
    const { fetchApprovedCurrentServices } = this.props;
    fetchApprovedCurrentServices(masterSession, data.page);
  }
                      ...
                      <div className="master-dashbord-container">
                        ...
                        <div className="master-side-menu">
                          ...
                          <div className="master-request-status">
                            ...
                            <div className="master-border" />
                            <a className="master-current-status" href="/master-accepted-request">Accepted Status</a>
                            <div className="master-border" />
                                    ...
                                    <div key={service.id}>
                                      <li>
                                        ...
                                        <p>
                                          ...
                                          <span className="span">{new Date(service.createdAt).toDateString()} {new Date(service.createdAt).toLocaleTimeString()}Z</span>
                                          <button
                                            type="submit"
                                          ...
                                          <span className="span-accept-status"><img src={AcceptMark} alt="rejectmark" />Accepted</span>
                                        </p>
                                      </li>
...
AcceptedRequest.defaultProps = {
  ...
  fetchApprovedCurrentServices: PropTypes.func,
};
...
const mapStateToProps = ({
  ...
  {
    loading: fetchApprovedServiceInitialState.loading,
    serverData: fetchApprovedServiceInitialState.data,
...
const mapDispatchToProps = (dispatch) => (
  {
    ...
    fetchApprovedCurrentServices: (masterSession, page) => {
      dispatch(fetchApprovedService(masterSession, page));
    },
...
export default connect(mapStateToProps, mapDispatchToProps)(AcceptedRequest);
