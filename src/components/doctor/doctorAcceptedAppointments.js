...
/**
 * This is DoctorAcceptedAppointment class which hold Doctor view Accepted Appointment component.
 */
class DoctorAcceptedAppointment extends Component {
  /* Srate Staff */
  constructor() {
    super();
    this.state = {
  ...
  componentDidMount() {
    const { history, doctorFetchCurrentApprovedAppointment, checkCurrentDoctorScam } = this.props;
    ...
    doctorFetchCurrentApprovedAppointment(doctorSession, 1);
  }

  nextPage(data) {
    const { doctorFetchCurrentApprovedAppointment } = this.props;
    const doctorSession = localStorage.getItem('token');
    doctorFetchCurrentApprovedAppointment(doctorSession, data.page);
  }
  ...
  doneAppointment(key, id) {
    ...
    const doctorSession = localStorage.getItem('token');
    if (doctorSession) {
      this.setState({ serverResult: 'Appointment Done Loading ...' });
                    ...
                    <div className="doctor-dashbord-container">
                      ...
                      <div className="doctor-side-menu">
                        ...
                        <div className="doctor-request-status">
                          <a className="doctor-current-status" href="/doctor-accepted-appointments">Upcoming Appointments</a>
                                      ...
                                      <li>
                                        ...
                                        <p>
                                          ...
                                          <button
                                            ...
                                            onClick={(key) => { this.doneAppointment(key, appointment.id); }}
...
DoctorAcceptedAppointment.defaultProps = {
  viewedLoading: false,
  viewedAppointment: {},
  ...
  doctorFetchCurrentApprovedAppointment: PropTypes.func,
};

DoctorAcceptedAppointment.propTypes = {
...
const mapStateToProps = ({
...
}) => (
  {
    ...
    loading: doctorFetchApprovedAppointmentInitialState.loading,
    serverData: doctorFetchApprovedAppointmentInitialState.data,
...
const mapDispatchToProps = (dispatch) => (
  {
    ...
    doctorFetchCurrentApprovedAppointment: (doctorSession, page) => {
      dispatch(doctorFetchApprovedAppointment(doctorSession, page));
    },
...
export default connect(mapStateToProps, mapDispatchToProps)(DoctorAcceptedAppointment);
