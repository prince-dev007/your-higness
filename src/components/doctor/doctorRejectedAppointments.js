...
/**
 * This is DoctorRejectedAppointment class which hold Doctor view rejected Appointment component.
 */
class DoctorRejectedAppointment extends Component {
  /* Srate Staff */
  constructor() {
    super();
    this.state = {
  ...
  componentDidMount() {
    const { history, doctorFetchCurrentRejectedAppointment, checkCurrentDoctorScam } = this.props;
    ...
    doctorFetchCurrentRejectedAppointment(doctorSession, 1);
  }
  ...
  nextPage(data) {
    const { doctorFetchCurrentRejectedAppointment } = this.props;
    const doctorSession = localStorage.getItem('token');
    doctorFetchCurrentRejectedAppointment(doctorSession, data.page);
  }
                    ...
                    <div className="doctor-dashbord-container">
                      ...
                      <div className="doctor-side-menu">
                        ...
                        <div className="doctor-request-status">
                          ...
                          <div className="doctor-border" />
                          <a className="doctor-current-status" href="/doctor-rejected-appointments">Rejected Appointments</a>
                          <div className="doctor-border" />
...
DoctorRejectedAppointment.defaultProps = {
  viewedLoading: false,
  viewedAppointment: {},
  ...
  doctorFetchCurrentRejectedAppointment: PropTypes.func,
};

DoctorRejectedAppointment.propTypes = {
...
const mapStateToProps = ({
  ...
  {
    loading: doctorFetchRejectedAppointmentInitialState.loading,
    serverData: doctorFetchRejectedAppointmentInitialState.data,
...
const mapDispatchToProps = (dispatch) => (
  {
    ...
    doctorFetchCurrentRejectedAppointment: (doctorSession, page) => {
      dispatch(doctorFetchRejectedAppointment(doctorSession, page));
    },
...
export default connect(mapStateToProps, mapDispatchToProps)(DoctorRejectedAppointment);
